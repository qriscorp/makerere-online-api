	...
	<div class="edu_admin_right sectionHolder edu_home_setting_wrapper">
	   ...
	   // print_r($eclass_data);die;
    				...
    				<div class="row">
    					...
    					if(!empty($todayClass)){ 
    						foreach($todayClass as $class){
    							echo '<div class="col-xl-6 col-lg-6 col-md-4 col-sm-12 col-xs-12">
					 ...
					 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 previewclassSearch">
		...
		<?php 
			    ...
			    echo '<section class="">
                        <div class="sectionHolder edu_add_users">
...
<!--<section class="edu_admin_content padding_none">-->
<!--	<div class="edu_admin_right sectionHolder edu_extra_classes edu_home_setting_wrapper"> -->
