...
<div id="liveclssJetsiPopup" class="liveclss_wrap" style="display: block;">
    <div class="liveclss_popup_wrap text-center">
        <div class="liveclss_popup_inner ">
            ...
            <h3 class="liveclss_sub"></h3>
            <p class="liveclss_topic"> </p>
            <a href="<?php echo base_url();?>class-start/<?php echo $this->session->userdata('batch_id');?>" class="edu_admin_btn liveclss_btn mt-3"><?php echo html_escape($this->common->languageTranslator('ltr_join'));?></a>
        </div>
    </div>
</div>
<!-- live class end-->
