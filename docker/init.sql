...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 09, 2023 at 12:29 PM
...
CREATE TABLE `exams` (
  ...
  `marking_parcent` varchar(250) NOT NULL DEFAULT '0',
  `status` int(11) NOT NULL,
  `added_by` int(11) NOT NULL,
  `added_at` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
(4, 'paypal client id', 'paypal_client_id', 'AUIlGljOWUkKjdx5QuVDCj5ljZcVtFKLvhU6k-3H5IZUwAAiYO0_ieLvVqpPnLcoHWvmoJQ_lkWzQFLa'),
(5, 'paypal secret key', 'paypal_secret_key', ''),
(6, 'select language type ', 'language_name', 'english'),
(7, 'select currency code', 'currency_code', 'MXN'),
...
(1, 1, '{\"admin_primary\":\"#6fa8dc\",\"admin_secondary\":\"white\",\"admin_accent\":\"#ff6e66\",\"admin_text\":\"#222222\",\"admin_alternate\":\"#3ac0da\",\"admin_header\":\"#6aa84f\"}', '{\"teacher_primary\":\"#6fa8dc\",\"teacher_secondary\":\"white\",\"teacher_accent\":\"#ff6e66\",\"teacher_text\":\"#222222\",\"teacher_alternate\":\"#3ac0da\",\"teacher_header\":\"#6aa84f\"}', '{\"student_primary\":\"#6fa8dc\",\"student_secondary\":\"white\",\"student_accent\":\"#ff6e66\",\"student_text\":\"#222222\",\"student_alternate\":\"#3ac0da\",\"student_header\":\"#6aa84f\"}', '{\"frontend_primary\":\"#6fa8dc\",\"frontend_secondary\":\"white\",\"frontend_accent\":\"#ff6e66\",\"frontend_text\":\"#222222\",\"frontend_alternate\":\"#3ac0da\",\"frontend_header\":\"#6aa84f\"}', '{\"login_primary\":\"#ff6e66\",\"login_secondary\":\"#222222\",\"login_alternate\":\"#222222\"}', 1);
...
(1, '1', 'admin', 'admin@eacademy.com', '202cb962ac59075b964b07152d234b70', 1, '', '', '29', '', '', 0, 1, '1', 'FpbjzPIVGH', '1', '');
...
--
-- Indexes for table `verification_login`
--
ALTER TABLE `verification_login`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `verification_login`
--
ALTER TABLE `verification_login`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
