<section class="edu_admin_content">
	<div class="edu_admin_right sectionHolder edu_teacher_manager">
		...
		<div class="edu_main_wrapper edu_table_wrapper sectionHolder ">
		     <div class="edu_table_wrapper edu_main_wrapper padding_none">
		...
		<?php 
		         ...
		         echo '<div class="edu_table_wrapper edu_main_wrapper padding_none">
                            <div class="edu_admin_informationdiv sectionHolder">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                        ...
                                        <div class="form-group">
                                            <span>
                                                <input type="text" Class="form-control chooseDate from_date" placeholder="'. html_escape($this->common->languageTranslator('ltr_from_date')).'"> 
                                            </span>
                                        </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                        ...
                                        <div class="form-group">
                                            <span>
                                                <input type="text" Class="form-control chooseDate to_date" placeholder="'. html_escape($this->common->languageTranslator('ltr_to_date')).'"> 
                                            </span>
                                        </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                        ...
                                        <div class="form-group">
                                            <span> 
                                                <input type="button" value="'. html_escape($this->common->languageTranslator('ltr_search')).'" Class="btn btn-primary filter_payment_history"> 
                                            </span>
                                        </div>
