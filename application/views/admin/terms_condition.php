						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
							    <div class="form-group">
									...
									<textarea rows="3" class="form-control term_condition require" id="term_condition" name="description"  placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_description'));?>"><?php echo !empty($terms_condition)?$terms_condition['0']['description']:'';?></textarea>
								</div>
							</div>
