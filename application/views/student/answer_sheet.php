                        ...
                        <div class="edu_answer_sheet_section">
                            <ol>
                                <?php 
                                    ...
                                    $questionLists = $this->db_model->select_data('id,question,answer,options,question_mask', 'questions use index (id)','id in ('.$allQuestions.')');
                                            ...
                                            echo ' <li>
                                                <div class="edu_single_answer_wrap">
                                                    <div class="edu_single_questionAns">
                                                        ...
                                                        <ul class="question_options">'.$option.' <span class="Answer_marks">'.$quest['question_mask'].' Marks</span></ul>
                                                    </div>
