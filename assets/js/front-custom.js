	...
	-----------------------------------------------------*/
		var Education = {
			...
			preLoader: function () {
				...
				var swiper = new Swiper(".edu-course-search-slider", swiperOptions);
    			},
                // search slider end
                CoursesearchSlider: function () {
                    var swiper = new Swiper('.edu-course-search-slider', {
                        loop: true,
    					speed: 1500,
                    ...
                    //  $(".swiper-container.edu-course-search-slider1").hover(function() {
...
// 			},
			...
			-----------------------------------------------------*/
			TeamSlider: function () {
				var TeamSwiper = new Swiper('.team_slider.swiper-container,.team_slider2,.edu-course-slider .swiper-container', {
					autoHeight: false,
					autoplay: true,
					spaceBetween: 30,
					slidesPerView: 4,
