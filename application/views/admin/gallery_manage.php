        ...
        <div class="edu_popup_inner">
            ...
            <form class="pxn_amin form" enctype="multipart/form-data" autocomplete="off">
		    	...
		    	<div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 edu_bottom_20 galleryVideoFld hide">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-12 galleryVideolink hide edu_bottom_20">
	   					<div class="form-group">
					<label><?php echo html_escape($this->common->languageTranslator('ltr_youtube_URL'));?><sup>*</sup></label>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-12 galleryVideofile hide edu_bottom_20">
						<div class="form-group">
