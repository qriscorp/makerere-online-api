...
<head>
    ...
    // print_r($student_themes);die;
    ?>
    <style>
    :root {
    --Primary-Color:<?php echo isset($student_themes['student_primary'])?$student_themes['student_primary']:'#4d4a81';?>;
    --Secondary-Color:<?php echo isset($student_themes['student_secondary'])?$student_themes['student_secondary']:'#f7f7fb';?> ;
    --delete-Color:<?php echo isset($student_themes['student_accent'])?$student_themes['student_accent']:'#f62d51';?> ;
    --Alternate-Text-Color:<?php echo isset($student_themes['student_text'])?$student_themes['student_text']:'#ffffff';?> ;
    --Active-icon-Color:<?php echo isset($student_themes['student_alternate'])?$student_themes['student_alternate']:'#3ac0da';?>;
     --edit-icon-Color:<?php echo isset($student_themes['student_header'])?$student_themes['student_header']:'#5fc5ff';?>;
	...
	<header class="edu_left_header">
		...
		<div class="edu_admin_header_right">
			<div class="edu_admin_menu">
			    <div class="edu_page_title mr-3 desktop-res-none">
            <a href="https://kamleshyadav.in/Eacademy_update/student/courses-data/All" class="edu_admin_btn">Browse Courses</a>
        </div>
				<ul>
					  ...
					  <li <?php echo in_array("syllabus",$cur_arr)?'class="active"':'';?>><a href="<?=(!empty($this->session->userdata('batch_id')))?base_url('student/syllabus/').$this->session->userdata('batch_id'):'javascript:void(0)';?>">
					   <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.004 512.004" style="enable-background:new 0 0 512.004 512.004;" xml:space="preserve">
					    ...
					    <span><?php echo html_escape($this->common->languageTranslator('ltr_syllabus')); ?></span>
					  	...
					  	<li hidden <?php echo in_array("start-class",$cur_arr)?'class="active"':'';?>><a href="<?=(!empty($this->session->userdata('batch_id')))?base_url('student/start-class/').$this->session->userdata('batch_id'):'javascript:void(0)';?>">
...
<div class="edu_admin_header edu_top_header">
    ...
    <div class="edu_admin_header_info">
          <div class="edu_page_title mr-3 res-none">
