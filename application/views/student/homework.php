<section class="edu_admin_content">
	<div class="edu_admin_right sectionHolder edu_extra_classes"> 
		...
		<?php 
			...
			?>
		<div class="edu_main_wrappe edu_main_wrapper">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div class="form-group">
							<span>
								<input type="text" class="chooseDate form-control filter_date" id="filter_Date"value="" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_select_date'));?>">
							</span>
						</div>
					</div>
