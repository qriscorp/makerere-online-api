...
function websdkready() {
  ...
  // get meeting args from url
    ...
    var SDK_key = document.getElementById('SDK_key').value;
    ...
    var leave_Url= document.getElementById('leaveurl').value;
    ...
    userEmail: (function () {
      try {
        return testTool.b64DecodeUnicode(userEmail);
      } catch (e) {
        return userEmail;
      }
    })(),
