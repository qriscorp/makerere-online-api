				...
				<form class="pxn_amin form" enctype="multipart/form-data" method="post">
					<div class="edu_site_setting_wrap edu_from_wrapper">
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-12 edu_bottom_20">
							...
							<div class="col-lg-6 col-md- col-sm-12 col-12 edu_bottom_20">
							    <div class="form-group">
							...
							<div class="col-lg-6 col-md- col-sm-12 col-12 edu_bottom_20 templateOption">
							    <div class="form-group col-lg-4 col-md- col-sm-12 col-12">
    							    <label><?php echo html_escape($this->common->languageTranslator('ltr_certificate_template'));?><sup>*</sup>
							        </label>
        							   	<select class="form-control   edu_selectbox_with_search " id="template_id" name="template_id" data-placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_certificate_template'));?>" > 
        							   	    <option value="1"<?php if(!empty($certi_setting[0]['template_id'])){if($certi_setting[0]['template_id']== 1){ echo "selected"; }} ;?>>Default Template</option>
                                            <option value="2"<?php if(!empty($certi_setting[0]['template_id'])){if($certi_setting[0]['template_id']== 2){ echo "selected"; }} ;?>>Template One</option>
                                            <option value="3"<?php if(!empty($certi_setting[0]['template_id'])){if($certi_setting[0]['template_id']== 3){ echo "selected"; }} ;?>>Template Two</option>
                                            <!--<option value="4"<?php if(!empty($certi_setting[0]['template_id'])){if($certi_setting[0]['template_id']== 4){ echo "selected"; }} ;?>>Template Three</option> -->
                                            <!--<option value="5"<?php if(!empty($certi_setting[0]['template_id'])){if($certi_setting[0]['template_id']== 5){ echo "selected"; }} ;?>>Template Four</option> -->
                                        </select>
							    </div>
							    <div class="form-group col-lg-2 col-md- col-sm-12 col-12">
							      <span class="optionCheckOld"> 
							        <?php
							            if($certi_setting[0]['template_id']==1){
							                ?><img src="<?=base_url();?>assets/images/certificate/default.png" class="default" width="300" height="200" ><?php
							            }else if($certi_setting[0]['template_id']==2){
							                ?><img src="<?=base_url();?>assets/images/certificate/template_one.png" class="template_one" width="300" height="200" ><?php
							            }else{
							                ?><img src="<?=base_url();?>assets/images/certificate/template_two.png" class="template_two" width="300" height="200" ><?php
							            }
							        ?>
							        </span>
							...
							<div class="col-lg-12 col-md-6 col-sm-12 col-12 edu_bottom_20">
							    <div class="form-group">
									...
									<p class="pxn-ins edu_top_10"><?php echo html_escape($this->common->languageTranslator('ltr_note'));?> : <?php echo html_escape($this->common->languageTranslator('ltr_wherever_batch'));?> </p>
								</div>
							</div>
							<div class="edu_btn_wrapper">
								<div class="col-lg-12 col-md-12 col-sm-12 col-12 "> 
									<button type="button" class="btn btn-primary updateCertificateSetting res-380-btn-block res-380-bottom"><?php echo html_escape($this->common->languageTranslator('ltr_save'));?></button>
									<a href="<?php echo base_url();?>admin/view-certificate-sample" class="btn btn-primary res-380-btn-block" target="_blank"><?php echo html_escape($this->common->languageTranslator('ltr_view_certificate'));?> </a>
