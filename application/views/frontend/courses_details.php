...
<section class="edu_courses_single edu_courses_single_Res">
    <div class="container">
        <div class="row">
...
<div class="edu-cousre-learn spacer-top spacer-bottom edu-course-bg-wrap edu_cousre_detailes">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
            ...
            <div class="col-md-7">
            <?php 
            foreach ($batch_fecherd as $key=>$value) {                 ?>
                ...
                <div class="edu-cousre-learn-list">
                    ...
                    <div class="course_details_ul course_details_ul_border">
                        <ul>
                       <?php
                        $fetured = json_decode($batch_fecherd[$key]['batch_fecherd']);
...
<div class="edu-course-content-wrap edu-course-content-wrap_res spacer-top spacer-bottom" id="edu-course-accordian">
    <div class="container">
        <div class="edu_heading_wrapper text-center">
            <h4 class="edu_subTitle"><?php $ttd =html_escape($this->common->languageTranslator('ltr_enhance')); echo !empty($frontend_details[0]['sec_crse_sub_heading'])?$frontend_details[0]['sec_crse_sub_heading']: $ttd;?></h4>
            <h4 class="edu_heading"><?php $cttd =html_escape($this->common->languageTranslator('ltr_our_courses')); echo !empty($frontend_details[0]['sec_crse_heading'])?$frontend_details[0]['sec_crse_heading']:$cttd ;?></h4>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if($getsubjectchapter){ ?>
                    ...
                    <div class="edu-course-accordian edu-course-accordian-flex">
