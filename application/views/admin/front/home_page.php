            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 padder0">
                        <div class="edu_courses_section Home-pageul">
                                            ...
                                            <div class="edu_courses_detail parentFormWrappr">
                                                ...
                                                <form class="pxn_amin" method="post">
                                                    ...
                                                    <?php 
                                                        ...
                                                        ?>
                                                        <div class="edu_home_slide_section parentRow sss">
                                                            <div class="row">
                                                        ...
                                                        <?php }?>
                                                        <div class="edu_btn_wrapper edu_btn-top-space">
                                                ...
                                                <div class="edu_home_wrapper edu_from_wrapper">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="edu_admin_testimonials ">
                                                            <div class="row">
                                                                <div class="col-md-6 pl-0 edu_bottom_20">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="edu_btn_wrapper  sectionHolder text-right responsive_center">
                                                        <button type="button" class="btn btn-primary addNewRow" data-type="selection"><i class="icofont-plus"></i><?php echo html_escape($this->common->languageTranslator('ltr_add_more'));?></button>
                                                                ...
                                                                ?>
                                                                    <div class="parentRow displayblock">
                                                                        <div class="row">
                                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-12 edu_bottom_20">
                                                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="edu_admin_testimonials">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 pr-0 edu_bottom_20">
                                                    <div class="edu_btn_wrapper  sectionHolder  text-right responsive_center">
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12"> 
                                                            ...
                                                            if(!empty($home_Details) && !empty($home_Details[0]['client_imgs'])){
                                                                ...
                                                                foreach($clients as $cln){
                                                                    echo '<div class="col-lg-2 col-md-3 col-sm-4 col-6 mb_30"><div class="eduClientSingleImages"><img src="'.base_url('uploads/site_data/').$cln.'" width="80"></div></div>';
                                                                }
                                                            }?>
                                                            </div>
                                                        </div>
