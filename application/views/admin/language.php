                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12 edu_bottom_20">
                        <div class="form-group">
                            <select name="language_type" class="form-control require edu_selectbox_with_search" data-symb="no" data-placeholder="Select Language"> 
								...
								<option <?php if($language_name=="hindi"){ echo 'selected';} ?> value="hindi">Hindi</option>
								<option <?php if($language_name=="german"){ echo 'selected';} ?> value="german">German</option>
								<option <?php if($language_name=="spanish"){ echo 'selected';} ?> value="spanish">Spanish</option> 
								</select>
