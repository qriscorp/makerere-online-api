                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 edu_bottom_20">
    					<div class="form-group ">
    						...
    						<label class="edu_top_10"><strong><?php echo html_escape($this->common->languageTranslator('ltr_note'));?> </strong> <?php echo html_escape($this->common->languageTranslator('ltr_upload_files_type'));?></label>
