...
<head>
    ...
    ?>
      <style>
        :root {
        --Primary-Color:<?php echo isset($teacher_themes['teacher_primary'])?$teacher_themes['teacher_primary']:'#4d4a81';?>;
        --Secondary-Color:<?php echo isset($teacher_themes['teacher_secondary'])?$teacher_themes['teacher_secondary']:'#f7f7fb';?> ;
        --delete-Color:<?php echo isset($teacher_themes['teacher_accent'])?$teacher_themes['teacher_accent']:'#f62d51';?> ;
        --Alternate-Text-Color:<?php echo isset($teacher_themes['teacher_text'])?$teacher_themes['teacher_text']:'#ffffff';?> ;
        --Active-icon-Color:<?php echo isset($teacher_themes['teacher_alternate'])?$teacher_themes['teacher_alternate']:'#3ac0da';?>;
         --edit-icon-Color:<?php echo isset($teacher_themes['teacher_header'])?$teacher_themes['teacher_header']:'#5fc5ff';?>;
