	...
	<div class="edu_admin_right sectionHolder">
		<div class="edu_admin_informationdiv sectionHolder showQuestionPaperWrapper">           
	        ...
	        <?php
                ...
                echo '<section class="edu_admin_content padding_none">
                        <div class="edu_admin_right sectionHolder edu_add_users padding_none">
                            <div class="edu_admin_informationdiv edu_main_wrapper">
                                <div class="eac_text eac_page_re">'.html_escape($this->common->languageTranslator('ltr_no_any_exam')).'</div>
                            </div>
                        </div>
...
<div id="autoSubmitPopup" class="edu_popup_container mfp-hide">
    <div class="edu_popup_wrapper">
        <div class="edu_popup_inner text-center">
            <h4 class="edu_sub_title nomarginbtm" style="font-weight: 900;"><?php echo html_escape($this->common->languageTranslator('ltr_time_out'));?></h4>
            <h3 class="edu_sub_title nomarginbtm"><?php echo html_escape($this->common->languageTranslator('ltr_time_out_s'));?></h3>
...
<div id="restartPracticePaper" class="edu_popup_container mfp-hide">
    <div class="edu_popup_wrapper">
        <div class="edu_popup_inner text-center">
            <h4 class="edu_sub_title nomarginbtm" style="font-weight: 900;"><?php echo html_escape($this->common->languageTranslator('ltr_time_out'));?></h4>
            <button type="button" class="edu_admin_btn restartPepar" ><?php echo html_escape($this->common->languageTranslator('ltr_restartpaper'));?></button>
        </div>
    </div>
</div>
