<!----- Page Title Start ----->
		...
		<!----- About Section Start ----->
		<section class="edu_about_wrapper edu_about_wrapper_responsive">
			<div class="container">
				<div class="row">
		...
		<section class="edu_mission_wrapper edu_mission_wrapper_res">
			<div class="container">
				<div class="row">
		...
		<section class="edu_vission_wrapper edu_vission_wrapper_Res">
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-md-12 col-sm-12 col-12">
