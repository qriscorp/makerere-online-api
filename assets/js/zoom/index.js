...
//           var joinUrl = baseurl+"admin/start-class?" + testTool.serialize(meetingConfig);
//           console.log(joinUrl);
...
//           "https://kamleshyadav.in/Eacademy_update/admin/start-class?"+testTool.serialize(meetingConfig);
