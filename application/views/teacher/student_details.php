<section class="edu_admin_content">
		...
		<div class="edu_admin_right sectionHolder edu_student_manager ">
		    	<div class="edu_admin_right sectionHolder edu_student_manager padding_none">
	    
	    <div  class="edu_table_wrapper sectionHolder margin-space">
			<div class="edu_admin_informationdiv">
                <form method="post" action="" autocomplete="off">
                    <div class="edu_manage_studer_filter edu_main_wrapper ss"> 
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 padding20-bottom">
                                <div class="form-group"> 
                                    <span> 
                                        <select class="form-control edu_selectbox_without_search" id="user_batch" name="user_batch[]" data-placeholder="Select Batch">
                            ...
                            <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12 padding20-bottom">
                                <div class="form-group"> 
                                    <span> 
		...
		<div class="createDivWrapper edu_add_question create_ppr_popup stdn_mng hide">
			...
			<div class="edu_admin_informationdiv dropdown_height">
                <div class="tableFullWrapper studentDetailsTable">
                    
                    <table class="server_datatable datatable table table-striped table-hover dt-responsive" id="studentManager"  cellspacing="0" width="100%" data-url="teacher_profile/student_Details_table/<?php echo $bid;?>">
                        <thead>
                            <tr>
        ...
        <div class="edu_popup_inner">
            ...
            <form method="post">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 edu_top_10">
