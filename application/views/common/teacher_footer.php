...
<div id="batchesData" class="edu_popup_container mfp-hide">
    <div class="edu_popup_wrapper">
        <div class="edu_popup_inner">
           <h4 class="edu_sub_title" id="charaTitele">Batches</h4>
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="form-group">
                        <div class="charactersViewResultBatch">
                           <a class="tbl_status_btn edu_btn_width light_sky_bg" data-id="26" href="javascript:;">cdcdscd</a><a class="tbl_status_btn edu_btn_width light_sky_bg" data-id="26" href="javascript:;">without cat testing</a>
                        </div>
                    </div>
				</div>
			</div>
