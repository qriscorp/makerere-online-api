                ...
                foreach($result_data as $result){
                   ...
                   if($result_data[0]['marking_parcent']==0){
                    ...
                    if ($result['percentage'] >= 90 && $result['percentage'] <= 100){
                        ...
                        if ($result['percentage'] >= 80 && $result['percentage'] < 90){
                            $grade = "A+ (Excellent)";
                        }else {
                            if ($result['percentage'] >= 70 && $result['percentage'] < 80){
                                $grade = "A (Very Good)";
                            }else {
                                if ($result['percentage'] >= 60 && $result['percentage'] < 70){
                                     $grade = "B+ (Good)";
                                }else {
                                    if ($result['percentage'] >= 50 && $result['percentage'] < 60){
                                        $grade = "B (Above average)";
                                    }else {
                                        if ($result['percentage'] >= 40 && $result['percentage'] < 50){
                                            $grade = "C (Average)";
                                        }else {
                                            if ($result['percentage'] >= 33 && $result['percentage'] < 40){
                                                $grade = "D (Pass)";
                                            }else {
                                                if ($result['percentage'] >=0 && $result['percentage'] < 33){
                                                    $grade = "F (Fail)";
                                                }else{
                                                    $grade = "Ab (Absent)";
                                                }
