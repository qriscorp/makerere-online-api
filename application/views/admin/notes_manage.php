...
<section class="edu_admin_content">
	<div class="edu_admin_right sectionHolder edu_video_manager">
	    ...
	    <div class="edu_table_wrapper edu_main_wrapper">
			<div class="edu_admin_informationdiv sectionHolder">
                <div class="tableFullWrapper padding_none">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 edu_bottom_20">
    					<div class="form-group">
                            ...
                            <select class="form-control require edu_selectbox_with_search filter_batch book_batch" name="batch[]"  data-placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_select_batch'));?>">
