	...
	<div class="sectionHolder edu_admin_right edu_dashboard_wrap">
        ...
        <div class="sectionHolder score_info_wrap">
    		<div class="edu_admin_informationdiv">
    		     <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 padding_none">
    		    ...
    		    <?php if(!empty($top_three)){ ?>
				    ...
				    <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
				        ...
				        <?php } ?>
				        <h4 class="edu_title edu_title_one"><?php echo html_escape($this->common->languageTranslator('ltr_student_performance'));?></h4>
