			...
			<div class="edu_admin_informationdiv sectionHolder">					
				<div class="tableFullWrapper">
				    <ul class="nav nav-tabs " role="tablist ">
							...
							<div class="tab-content edu_btn-top-space">
            ...
            <form class="pxn_amin form" enctype="multipart/form-data" method="post" autocomplete="off">
                <div class="row">
    				...
    				<div class="col-lg-12 col-md-12 col-sm-12 col-12 edu_bottom_20">
    					<div class="form-group add_edit_question edu_bottom_20">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-12 edu_bottom_20">
					    <label class="ans_option"><?php echo html_escape($this->common->languageTranslator('ltr_add_mask'));?><sup>*</sup></label>
					    <input type="number" class="form-control " name="question_mask" autocomplete="off" placeholder="Question Marks">
					</div>
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 edu_bottom_20">
             ...
             <div role="tabpanel" class="tab-pane fade" id="bulk">
                ...
                <div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-12">
    					<div class="edu_btn_wrapper edu_top_10">
