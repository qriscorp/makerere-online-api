        ...
        <div class="edu_popup_inner">
            ...
            <form method="post" class="pxn_amin form" action="javascript:void(0)" autocomplete="off"> 
                <div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-12">
    					<div class="edu_btn_wrapper">
							<input type="button" name="editsubject" value="<?php echo html_escape($this->common->languageTranslator('ltr_update'));?>" class="edu_admin_btn editSubject" data-id="" />
						</div>
    				</div>
				</div>
            </form>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
    					<div class="form-group">
                            ...
                            <p class="edu_top_10"><?php echo html_escape($this->common->languageTranslator('ltr_chsapter_note'));?></p>
                        </div>
    				</div>
					<div class="col-lg-12 col-md-12 col-sm-12 col-12">
    					<div class="edu_btn_wrapper">
