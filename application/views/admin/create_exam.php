	...
	<div class="edu_admin_right sectionHolder edu_creat_exam">
		...
		<div class="edu_admin_informationdiv sectionHolder">
		    <div class="edu_main_wrapper edu_table_wrapper">
			    <div class="row">
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 edu_bottom_20">
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-12 edu_bottom_20">	
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="row">
							...
							<div class="col-lg-8 col-md-8 col-sm-12 col-12 res-bottom-20">
								<div class="form-group">
									<span>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-12 col-sm-12 col-12 mocktesthideshow hide">
						<div class="form-group"> 
							...
							<input type="text" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_schedule_date')); ?>" id="mockPaperStartDate" class="form-control mockPaperStartDate" name="mock_sheduled_date">
						</div>
					</div>
					<div class="col-lg-6 col-md-12 col-sm-12 col-12 mocktesthideshow hide">
						<div class="form-group"> 
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 paper_update   <?php isset($exam_paper[0]['type'])==1 ? '':'Hide'?>">
						<div class="form-group paper_updatecheckbox"> 
    						<label><?php echo html_escape($this->common->languageTranslator('ltr_Negative'));?>
                            <input type="checkbox" class="academics " id="add_marking" name="negative_marking" value="1"></label>
                            	<label><?php echo html_escape($this->common->languageTranslator('ltr_Negative_d'));?> <input type="checkbox" id="add_marking_d"  class="academics "name="negative_marking" ></label>
                            <br><?php echo html_escape($this->common->languageTranslator('ltr_note'));?> :- <span style="color:red;"><?php echo html_escape($this->common->languageTranslator('ltr_value_set')); ?></span>
						</div>
					</div>
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 marking_value">
						<div class="form-group"> 
							<input type="number" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_marking_value')); ?> %" class="form-control markingNegative" name="marking_parcent">
						</div>
					</div>
					<div class="col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="form-group">
