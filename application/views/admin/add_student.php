...
<section class="edu_admin_content">
    <div class="edu_admin_right edu_admin_right_addStudent sectionHolder edu_add_users">
        <div class="edu_admin_informationdiv edu_main_wrapper edu_add_student_wrapper">
            <form class="form" id="add_student_form" method="post" enctype="multipart/form-data" autocomplete="off" >
                <div class="row">
                    ...
                    <div class="offset-lg-6 offset-md-6 col-lg-6 col-md-6 col-sm-12 col-12 edu_bottom_20">
                        <div class="form-group">
                            <span>
                            <?php
                            ...
                            ?>
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12 res-bottom-20">
                                        <div class="form-group">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 edu_bottom_20" >
                        <div class="edu_title_wrapper">
                         ...
                         <div class="col-lg-6 col-md-6 col-sm-12 col-12 multibatchAdd edu_bottom_20">
                        <div class="form-group"> 
                        ...
                        <div class="edu_title_wrapper">
                            <h4 class="edu_sub_title">
                               <?php echo html_escape($this->common->languageTranslator('ltr_old_batch'));?>
                            </h4>
