<section class="edu_admin_content edu_admin_content_manage_admin">
                    ...
                    <table class="server_datatable datatable table table-striped table-hover dt-responsive" cellspacing="0" width="100%" data-url="ajaxcall/admin_table">
                        <thead>
                            <tr>
                                ...
                                <th class="no-sort">Direct Login (SA)</th>
...
<!-- Pop Up Start  -->
<div id="input_feilds_admin" class="edu_popup_container mfp-hide adminManage_popup">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 edu_bottom_20">
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12 col-12 edu_bottom_20">
                        ...
                        <div class="form-group eb_batchtype">
                            ...
                            <div class="form-control adminAccessControlDiv">
                                <label class="AdminAccess"><span clas="accessname"><?php echo html_escape($this->common->languageTranslator('ltr_academics'));?></span>
                                    <input type="checkbox" class="academics" name="academics" value="1"></label>
                                <label class="AdminAccess"><span clas="accessname"><?php echo html_escape($this->common->languageTranslator('ltr_gallery_manager'));?></span>
                                    <input type="checkbox" class="gallary_manage" name="gallary_manage" value="1"></label>
                                <label class="AdminAccess"><span clas="accessname"><?php echo html_escape($this->common->languageTranslator('ltr_library_manager'));?></span>
                                    <input type="checkbox" class="library_manager" name="library_manager" value="1"></label>
                                <label class="AdminAccess"><span clas="accessname"><?php echo html_escape($this->common->languageTranslator('ltr_question_manager'));?></span>
                                    <input type="checkbox" class="question_manager" name="question_manager" value="1"></label>
                                <label class="AdminAccess"><span clas="accessname"><?php echo html_escape($this->common->languageTranslator('ltr_video_lecture_manager'));?></span>
                                    <input type="checkbox" class="video_lecture" name="video_lecture" value="1"></label>
                                <label class="AdminAccess"><span clas="accessname"><?php echo html_escape($this->common->languageTranslator('ltr_doubts_ask'));?></span>
                                    <input type="checkbox" class="doubtsask" name="doubtsask" value="1"></label>
                                <label class="AdminAccess"><span clas="accessname"><?php echo html_escape($this->common->languageTranslator('ltr_exam'));?></span>
                                    <input type="checkbox" class="exam" name="exam" value="1"></label>  
                                <label class="AdminAccess"><span clas="accessname"><?php echo html_escape($this->common->languageTranslator('ltr_teacher_manager'));?></span>
                                ...
                                <label class="AdminAccess"><span clas="accessname"><?php echo html_escape($this->common->languageTranslator('ltr_enquiry'));?></span>
