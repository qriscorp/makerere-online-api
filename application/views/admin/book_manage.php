	...
	<div class="edu_admin_right sectionHolder edu_video_manager">
	    ...
	    <div class="edu_btn_wrapper sectionHolder padderBottom30 text-right ">
                ...
                <?php 
                    if($role ==1 || $role ==3){
                        ?>
                        <button  class="edu_admin_btn addBookPop"><i class="icofont-plus"></i><?php echo html_escape($this->common->languageTranslator('ltr_add_book'));?></button>
                        <?php
                    }
                ?>
        ...
        <div class="edu_table_wrapper margin_bottom_none">
			<div class="edu_admin_informationdiv sectionHolder edu_main_wrapper">
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="form-group">
							<span>
                                <select class="form-control filter_subject edu_selectbox_with_search" id="Filter_Subject" value="<?php echo $book_data[0]['subject']?>" name="filter_subject" data-placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_select_subject'));?>" data-count="no">
	    ...
	    <div class="edu_table_wrapper ">
			<div class="edu_admin_informationdiv sectionHolder">
                <div class="tableFullWrapper edu_main_wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 edu_bottom_20">
    					<div class="form-group">
                            ...
                            <select id="batch_reset" class="form-control require edu_selectbox_with_search get_teacher_subject" name="batch_id"  data-placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_select_batch'));?>" >
