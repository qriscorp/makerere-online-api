<section class="edu_admin_content">
	...
	<div class="edu_admin_right sectionHolder edu_question_manager">
    		    ...
    		    <div class="ppr_popup_inner">
        			<div class="row align-items-center text-center">
        			    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
        				    ...
        				    <a href="#subjectsPopup" class="edu_admin_btn openPopupLink "><i class="icofont-plus"></i><?php echo html_escape($this->common->languageTranslator('ltr_add_mask'));?></a> 
                		</div>
					</div>
        		</div>
    		</div>
		...
		<div class="edu_main_wrapper edu_table_wrapper">
		    <div class="edu_btn_wrapper sectionHolder padderBottom30">
	         <div class="row">
	            <div class="col-lg-3 col-md-3 col-sm-6 col-12 res-bottom-20">
	                <?php 
        			if(!empty($question_data)){
        			?>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-12 res-top-20 aa">
				    <?php 
        			if(!empty($question_data)){
        			?>
					<div class="form-group">
	       ...
	       <!-- <a href="#bulkquestionPopup" class="edu_admin_btn openPopupLink"><i class="icofont-plus"></i>Upload</a>-->
	        <!-- <a href="#questionPopup" class="edu_admin_btn openPopupLink addQuestionPopShow" data-placement="botto" ><i class="icofont-plus"></i><?php echo html_escape($this->common->languageTranslator('ltr_add_question'));?></a> -->
                        ...
                        <?php if($_SESSION['role']==1){?>
            	        	<div class="col-lg-3 col-md-3 col-sm-6 col-12 text-sm-right res-top-20">
    				...
    				<table class="server_datatable datatable table table-striped table-hover dt-responsive" cellspacing="0" width="100%" data-url="ajaxcall/question_table/question">
    					<thead>
    						<tr> 
    							...
    							<th><?php echo html_escape($this->common->languageTranslator('ltr_question_mask'));?></th>
...
<!--Add Question Mask -->
<div id="subjectsPopup" class="edu_popup_container add_question_mask mfp-hide">
    <div class="edu_popup_wrapper">
        <div class="edu_popup_inner">
            <h4 class="edu_sub_title" id="myModalLabel1"><?php echo html_escape($this->common->languageTranslator('ltr_add_mask'));?></h4>
            <form method="post" class="pxn_amin form" action="javascript:void(0)" autocomplete="off"> 
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
    					<div class="form-group">
                            <label><?php echo html_escape($this->common->languageTranslator('ltr_add_mask'));?><sup>*</sup></label>
                            <input type="number" name="add_mask" id="add_mask" class="form-control" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_enter_number'));?>" />
                        </div>
    				</div>
					<div class="col-lg-12 col-md-12 col-sm-12 col-12">
    					<div class="edu_btn_wrapper">
							<input type="button" value="<?php echo html_escape($this->common->languageTranslator('ltr_add_mask'));?>" data-table="questions" data-column="question_mask" class="edu_admin_btn add_mask" />
						</div>
    				</div>
				</div>
            </form>
