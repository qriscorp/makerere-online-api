    ...
    <div class="container">
        <div class="row">            
            <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                <div class="edu_sglblog_section edu_sglblog_section_Res">
				<?php if(!empty($blog)){ 
					...
					?>
                    <div class="edu_sglblog_inner bgshadowradios mb_30 Blog-Page">
                        ...
                        <p class="edu_sglblog_des">
                            <?php if(!empty($value['description'])){ if(strlen($value['description'])<250)
                            { 
                                echo  closetags(html_entity_decode(substr($value['description'], 0, 250)),ENT_QUOTES, 'UTF-8') ;}
                            else{ 
                            echo  closetags(html_entity_decode(substr($value['description'], 0, 250)),ENT_QUOTES, 'UTF-8'); 
                            ?> 
                            <a class="edu_btn" href="<?php echo base_url('/blog/').$value['id']; ?>"><?php echo html_escape($this->common->languageTranslator('ltr_read_more'));?> </a> <?php 
                            } } ?>
                        </p>
                    </div>
					<?php }
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                <div class="sglblog_sidebar sglblog_sidebar_res">
                    ...
                    <div class="sglblog_recent bgshadowradios mb_30">
                        ...
                        <ul class="blog_recent_list blog_recent_list_blog_page">
